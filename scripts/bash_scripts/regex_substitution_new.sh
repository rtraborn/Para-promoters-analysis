...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp4.3 > tmp4.4
perl -pe 's/(\*)/NA\tNA/g' tmp4.4 > Pbi_col.txt
...
perl -pe 's/(\*)/NA\tNA/g' tmp5.4  > Pdec_col.txt
...
perl -pe 's/(\*)/NA\tNA/g' tmp6.4 > Pdodec_col.txt 
...
perl -pe 's/(\*)/NA\tNA/g' tmp7.4 > Pjenn_col.txt 
...
perl -pe 's/(\*)/NA\tNA/g' tmp8.4 > Pnov_col.txt 
...
perl -pe 's/(\*)/NA\tNA/g' tmp9.4 > Poct_col.txt 
...
perl -pe 's/(\*)/NA\tNA/g' tmp10.4 > Ppent_col.txt
...
perl -pe 's/(\*)/NA\tNA/g' tmp11.5 > Pprim_col.txt 
...
perl -pe 's/(\*)/NA\tNA/g' tmp12.4 > Pquad_col.txt 
...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp13.3 > tmp13.4
perl -pe 's/(\*)/NA\tNA/g' tmp13.4 > Psept_col.txt 
...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp14.3 > tmp14.4
perl -pe 's/(\*)/NA\tNA/g' tmp14.4 > Psex_col.txt
...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp15.3 > tmp15.4
perl -pe 's/(\*)/NA\tNA/g' tmp15.4 > Pson_col.txt 
...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp16.3 > tmp16.4 
perl -pe 's/(\*)/NA\tNA/g' tmp16.4 > Ptet_col.txt
...
perl -pe 's/(\.)(\,)(\.)/\1\t\3/g' tmp17.3 > tmp17.4
perl -pe 's/(\*)/NA\tNA/g' tmp17.4 > Ptred_col.txt 
